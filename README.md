...
**compound-engineering-plugin** is only required for `/aimi:brainstorm`. All other commands (plan, deepen, execute, review, status) work standalone.
...
# (Optional) Install compound-engineering for /aimi:brainstorm
...
- Only `/aimi:brainstorm` requires compound-engineering
...
| Skills | 3 | `task-planner`, `plan-to-tasks`, `story-executor` |
