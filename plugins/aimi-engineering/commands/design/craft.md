...
Read `${CLAUDE_PLUGIN_ROOT}/skills/frontend-design/references/index.md` to resolve the register (brand vs product) and identify which reference files apply to this surface.

Based on the design brief's "Recommended References" section, consult the relevant reference files under `${CLAUDE_PLUGIN_ROOT}/skills/frontend-design/references/`. At minimum, always consult:

- `${CLAUDE_PLUGIN_ROOT}/skills/frontend-design/references/spatial-design.md` for layout and spacing
- `${CLAUDE_PLUGIN_ROOT}/skills/frontend-design/references/typography.md` for type hierarchy

Then add references based on the brief's needs:
- Complex interactions or forms? Consult `${CLAUDE_PLUGIN_ROOT}/skills/frontend-design/references/interaction-design.md`
- Animation or transitions? Consult `${CLAUDE_PLUGIN_ROOT}/skills/frontend-design/references/motion-design.md`
- Color-heavy or themed? Consult `${CLAUDE_PLUGIN_ROOT}/skills/frontend-design/references/color-and-contrast.md`
- Responsive requirements? Consult `${CLAUDE_PLUGIN_ROOT}/skills/frontend-design/references/responsive-design.md`
- Heavy on copy, labels, or errors? Consult `${CLAUDE_PLUGIN_ROOT}/skills/frontend-design/references/ux-writing.md`
- Brand/marketing surface? Also read `${CLAUDE_PLUGIN_ROOT}/skills/frontend-design/references/brand.md`
- Product/app surface? Also read `${CLAUDE_PLUGIN_ROOT}/skills/frontend-design/references/product.md`
