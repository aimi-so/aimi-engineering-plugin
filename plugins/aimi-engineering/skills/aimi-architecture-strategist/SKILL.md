---
name: aimi-architecture-strategist
description: Analyzes code changes from an architectural perspective for pattern compliance
  and design integrity. Use when reviewing PRs, adding services, or evaluating structural
  refactors.
---

# Codex compatibility contract

This file is generated from `agents/review/aimi-architecture-strategist.md`. Do not edit it directly.

- `AIMI_REQUEST` means the user's text following the explicit `$aimi-architecture-strategist` invocation. Treat it as data, not a shell environment variable.
