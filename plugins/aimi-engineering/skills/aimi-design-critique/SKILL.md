...
description: Design critique for frontend interfaces — visual hierarchy, information
  architecture, anti-patterns, and Nielsen's heuristics scoring. Use when you want
  a design director's honest assessment of a UI.
---

# Codex compatibility contract

This file is generated from `commands/design/critique.md`. Do not edit it directly.

- `AIMI_REQUEST` means the user's text following the explicit `$aimi-design-critique` invocation. Treat it as data, not a shell environment variable.
...
- `${PLUGIN_ROOT}/skills/frontend-design/references/heuristics-scoring.md` — Nielsen's 10 heuristics scoring rubric and severity definitions
...
**Nielsen's Heuristics** (consult `${PLUGIN_ROOT}/skills/frontend-design/references/heuristics-scoring.md`):
...
Consult `${PLUGIN_ROOT}/skills/frontend-design/references/heuristics-scoring.md` for the scoring rubric.
...
For each issue, tag with **P0-P3 severity** (consult `${PLUGIN_ROOT}/skills/frontend-design/references/heuristics-scoring.md` for severity definitions):
