---
name: aimi-bug-reproduction-validator
description: Systematically reproduces and validates bug reports to confirm whether
  reported behavior is an actual bug. Use when you receive a bug report or issue that
  needs verification.
---

# Codex compatibility contract

This file is generated from `agents/workflow/aimi-bug-reproduction-validator.md`. Do not edit it directly.

- `AIMI_REQUEST` means the user's text following the explicit `$aimi-bug-reproduction-validator` invocation. Treat it as data, not a shell environment variable.
