---
name: aimi-kieran-python-reviewer
description: Reviews Python code with an extremely high quality bar for Pythonic patterns,
  type safety, and maintainability. Use after implementing features, modifying code,
  or creating new Python modules.
---

# Codex compatibility contract

This file is generated from `agents/review/aimi-kieran-python-reviewer.md`. Do not edit it directly.

- `AIMI_REQUEST` means the user's text following the explicit `$aimi-kieran-python-reviewer` invocation. Treat it as data, not a shell environment variable.
