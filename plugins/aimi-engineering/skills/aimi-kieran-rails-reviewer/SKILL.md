---
name: aimi-kieran-rails-reviewer
description: Reviews Rails code with an extremely high quality bar for conventions,
  clarity, and maintainability. Use after implementing features, modifying code, or
  creating new Rails components.
---

# Codex compatibility contract

This file is generated from `agents/review/aimi-kieran-rails-reviewer.md`. Do not edit it directly.

- `AIMI_REQUEST` means the user's text following the explicit `$aimi-kieran-rails-reviewer` invocation. Treat it as data, not a shell environment variable.
