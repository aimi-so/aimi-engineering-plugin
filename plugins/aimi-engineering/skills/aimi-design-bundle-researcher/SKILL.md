...
description: Ingests a Claude Design handoff bundle (DesignSpec.md, BusinessSpec.md,
  chats, prototypes) and emits a structured 16-section research document. Use when
  Claude Design handoff bundle is present before brainstorm or planning.
---

# Codex compatibility contract

This file is generated from `agents/research/aimi-design-bundle-researcher.md`. Do not edit it directly.

- `AIMI_REQUEST` means the user's text following the explicit `$aimi-design-bundle-researcher` invocation. Treat it as data, not a shell environment variable.
