---
name: aimi-spec-flow-analyzer
description: Analyzes specifications and feature descriptions for user flow completeness
  and gap identification. Use when a spec, plan, or feature description needs flow
  analysis, edge case discovery, or requirements validation.
---

# Codex compatibility contract

This file is generated from `agents/workflow/aimi-spec-flow-analyzer.md`. Do not edit it directly.

- `AIMI_REQUEST` means the user's text following the explicit `$aimi-spec-flow-analyzer` invocation. Treat it as data, not a shell environment variable.
