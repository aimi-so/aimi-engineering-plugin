---
name: aimi-performance-oracle
description: Analyzes code for performance bottlenecks, algorithmic complexity, database
  queries, memory usage, and scalability. Use after implementing features or when
  performance concerns arise.
---

# Codex compatibility contract

This file is generated from `agents/review/aimi-performance-oracle.md`. Do not edit it directly.

- `AIMI_REQUEST` means the user's text following the explicit `$aimi-performance-oracle` invocation. Treat it as data, not a shell environment variable.
...
<commentary>
Since the user is concerned about scalability, use the Codex subagent tool to launch the performance-oracle agent to analyze the code for performance issues.
</commentary>
</example>
</examples>
