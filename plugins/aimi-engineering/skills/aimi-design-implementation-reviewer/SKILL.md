...
description: Visually compares live UI implementation against Figma designs OR Claude
  Design prototype HTML and provides detailed feedback on discrepancies. Use after
  writing or modifying HTML/CSS/React components to verify design fidelity.
---

# Codex compatibility contract

This file is generated from `agents/design/aimi-design-implementation-reviewer.md`. Do not edit it directly.

- `AIMI_REQUEST` means the user's text following the explicit `$aimi-design-implementation-reviewer` invocation. Treat it as data, not a shell environment variable.
