<!-- Ported from Anthropic Impeccable v3.0.5 reference/interaction-design.md (Apache-2.0). See ../NOTICE.md. -->
...
**Avoid**: Removing focus indicators without alternatives. Using placeholder text as labels. Touch targets smaller than 44x44px. Generic error messages. Custom controls without ARIA/keyboard support.
