<!-- Ported from Anthropic Impeccable v3.0.5 reference/motion-design.md (Apache-2.0). See ../NOTICE.md. -->
...
**For micro-interactions, use exponential ease-out curves**—they feel natural because they mimic real physics (friction, deceleration):
