<!-- Ported from Anthropic Impeccable v3.0.5 reference/personas.md (Apache-2.0). See ../NOTICE.md. -->
...
If the project has documented target audience and brand information, derive 1-2 additional personas from that context:
...
**Profile**: [2-3 key characteristics derived from audience context]
...
Only generate project-specific personas when real audience data is available. Don't invent audience details -- use the 5 predefined personas when no context exists.
