<!-- Ported from Anthropic Impeccable v3.0.5 reference/typography.md (Apache-2.0). See ../NOTICE.md. -->
...
Popular ratios: 1.25 (major third), 1.333 (perfect fourth), 1.5 (perfect fifth). Pick one ratio ≥1.25 and commit.
