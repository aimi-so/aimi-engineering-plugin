<!-- Ported from Anthropic Impeccable v3.0.5 reference/cognitive-load.md (Apache-2.0). See ../NOTICE.md. -->
...
- [ ] **Chunking**: Is information presented in digestible groups (4 or fewer items per group)?
...
- [ ] **Minimal choices**: Are decisions simplified (4 or fewer visible options at any decision point)?
...
**Humans can hold 4 or fewer items in working memory at once** (Miller's Law revised by Cowan, 2001).
...
- Form sections: 4 or fewer fields visible per group before a visual break
- Action buttons: 1 primary, 1-2 secondary, group the rest in a menu
- Dashboard widgets: 4 or fewer key metrics visible without scrolling
