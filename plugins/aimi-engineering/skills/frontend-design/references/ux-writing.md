<!-- Ported from Anthropic Impeccable v3.0.5 reference/ux-writing.md (Apache-2.0). See ../NOTICE.md. -->
...
**Avoid**: Jargon without explanation. Blaming users ("You made an error" means "This field is required"). Vague errors ("Something went wrong"). Varying terminology for variety. Humor for errors.
